    ...
    <div className="relative isolate overflow-hidden pt-[5.75rem]">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="prose prose-sm prose-slate mx-auto max-w-[40rem] text-gray-600 prose-a:font-semibold prose-a:text-primary hover:prose-a:text-primary/80">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Vibrations
                Consultancy LLP, Lotus Boulevard, Sector-100, Noida.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to GroVr, accessible from{" "}
                <a
                  href="https://grovrtesting.com/"
                  rel="external nofollow noopener"
                  target="_blank"
                  data-uno-hassubmittext="no"
                >
                  https://grovrtesting.com/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p>By email: grovrtesting@gmail.com</p>
            </li>
            <li>
              <p>
