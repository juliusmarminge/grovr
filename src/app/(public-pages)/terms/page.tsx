const Terms = () => {
  return (
    <div className="relative isolate overflow-hidden pt-[5.75rem]">
      <svg
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="prose prose-sm prose-slate mx-auto max-w-[40rem] text-gray-600 prose-a:font-semibold prose-a:text-primary hover:prose-a:text-primary/80">
          <p>Welcome to GroVr!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of Vibrations Consultancy LLP's Website, located at
            www.grovrtesting.com.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use GroVr if you do not agree to take
          ...
          <p>
            We employ the use of cookies. By accessing GroVr, you agreed to use
            cookies in agreement with the Vibrations Consultancy LLP's Privacy
            Policy.{" "}
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, Vibrations Consultancy LLP and/or its
            licensors own the intellectual property rights for all material on
            GroVr. All intellectual property rights are reserved. You may access
            this from GroVr for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Republish material from GroVr</li>
            <li>Sell, rent or sub-license material from GroVr</li>
            <li>Reproduce, duplicate or copy material from GroVr</li>
            <li>Redistribute content from GroVr</li>
          </ul>
          <p>
          ...
          <p>
            ...
            Vibrations Consultancy LLP does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Vibrations Consultancy LLP,its
            ...
            permitted by applicable laws, Vibrations Consultancy LLP shall not
          ...
          <p>
            Vibrations Consultancy LLP reserves the right to monitor all
          ...
          <p>
            You hereby grant Vibrations Consultancy LLP a non-exclusive license
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Vibrations
            Consultancy LLP; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to Vibrations Consultancy LLP. Please include your
          ...
          <p>
            No use of Vibrations Consultancy LLP's logo or other artwork will be
