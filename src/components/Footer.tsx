...
const navigation = {
  main: [
    ...
    { name: "Blog", href: "/blog" },
    { name: "Jobs", href: CONSTANTS.LINKS.jobsURL, target: "_blank" },
    { name: "FAQs", href: "/product#faqs" },
    { name: "Contact", isButton: true, onClick: () => Crisp.chat.open() },
  ...
  social: [
    ...
    {
      name: "Instagram",
      href: CONSTANTS.LINKS.instagramURL,
      icon: (props: SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "LinkedIn",
      href: CONSTANTS.LINKS.linkedInURL,
      icon: (props: SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fill="currentColor"
      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <div>
          <p className="mt-10 text-center text-xs leading-5 text-gray-500">
            &copy; 2023 Vibrations Consultancy LLP. All rights reserved.
          </p>
